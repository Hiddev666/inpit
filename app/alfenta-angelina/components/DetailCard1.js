...
const DetailCard1 = (props) => {
    ...
    return (
        <div className={`w-full bg-white p-6 rounded-md bg-[url(/img/alfenta-angelina/bg-card-1.png)] bg-cover bg-top h-100 flex flex-col justify-between`} data-aos="fade-up">
