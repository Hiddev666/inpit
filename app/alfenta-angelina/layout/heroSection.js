...
const HeroSection = (props) => {
    return (
        <div className="bg-neutral-800 bg-[url(/img/alfenta-angelina/blured.png)] bg-cover bg-center overflow-hidden flex flex-col justify-start items-center p-10 relative" id="hero">
            <Image
            ...
            <div className="w-3/4 flex flex-col items-center gap-5">
                <Image
                    src={"/img/alfenta-angelina/logo.svg"}
                    width={100}
                    height={100}
                    alt="Logo"
                    data-aos="zoom-in"
