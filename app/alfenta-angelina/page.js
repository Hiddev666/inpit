        ...
        return (
            <div className="w-full h-screen fixed bg-white z-100 flex justify-center items-center">
                <div className="flex flex-col gap-3 overflow-hidden">
                    <h1 className={`text-3xl sm:text-4xl ${cormorant.className} text-neutral-900 overflow-hidden`} data-aos="fade-up" data-aos-once="true">ALFENTA<br />& ANGELINA</h1>
                    <a href="#greeting">
                        <button className="cursor-pointer font-medium flex gap-2 p-2 rounded-md w-max bg-[#8F1515] text-white" onClick={() => setLoadingVisible(true)} data-aos="fade-down" data-aos-delay="200" data-aos-duration="1000">
                            <Image
